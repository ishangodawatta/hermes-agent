...
TOOLSETS = {
    ...
    "relay": {
        "description": "Cross-chat relay: queue a fact for background delivery, or log an activity for automatic same-day cross-person matching (local-only feature)",
        "tools": ["relay_note", "log_activity"],
        "includes": []
    },
